...
public class ExecutableFactory {
  ...
  public Executable makeExecutable(String execCommand) {
    ...
    switch(executableType) {
      case "Forward":
        newExecutable = new forwardExecutable(parsedCommand[1]);  //Replace with properties call
      case "Backward":
        newExecutable = new backExecutable(parsedCommand[1]);
      case "Left":
        newExecutable = new leftExecutable(parsedCommand[1]);
      case "Right":
        newExecutable = new rightExecutable(parsedCommand[1]);
      case "SetHeading":
        newExecutable = new sethExecutable(parsedCommand[1]);
      case "SetTowards":
        newExecutable = new towardsExecutable(parsedCommand[1]);
      case "SetPosition":
        newExecutable = new setxyExecutable(parsedCommand[1]);
      case "PenDown":
        newExecutable = new pendownExecutable(parsedCommand[1]);
      case "PenUp":
        newExecutable = new penupExecutable(parsedCommand[1]);
      case "ShowTurtle":
        newExecutable = new showTurtleExecutable(parsedCommand[1]);
      case "HideTurtle":
        newExecutable = new hideTurtleExecutable(parsedCommand[1]);
      case "Home":
        newExecutable = new homeExecutable(parsedCommand[1]);
      case "ClearScreen":
        newExecutable = new clearExecutable(parsedCommand[1]);
    }
